...
class CustomDataset(Dataset):
    ...
    def _load_filenames_and_labels(self):
        ...
        class_dirs = {'notumor': 0, 'meningioma': 1, 'pituitary': 1}  
...
def main():
    ...
    train_dir = f'/data/user1/AlphaGANMRI/{train_path}/Training'
    val_dir = f'/data/user1/AlphaGANMRI/{train_path}/Testing'
    ...
    class_names = ['Not Tumor', 'Tumor']  # Adjust according to your classes
    file_path = f'/data/user1/AlphaGANMRI/v3/test1_classification_models/confusion_{lr}_{batch_size}_{train_path}'
    ...
    # Plot and save
    plot_and_save_metrics(history, file_path,f'model_{lr}_{batch_size}_{train_path}')

    # Save the trained model
    torch.save(model.state_dict(), f'{file_path}/model_{lr}_{batch_size}_{train_path}.pth')
